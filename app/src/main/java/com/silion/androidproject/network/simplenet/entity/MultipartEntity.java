package com.silion.androidproject.network.simplenet.entity;
...
public class MultipartEntity implements HttpEntity {
     ...
     * @param fileName
     */
    private void writeToOutputStream(String key, byte[] rawData, String type,
                                     byte[] encodingBytes,
                                     String fileName) {
        try {
            writeFirstBoundary();
            ...
            mOutputStream
                    .write(getContentDispositionBytes(key, fileName));
    ...
    public void addBinaryPart(String key, final byte[] rawData) {
        writeToOutputStream(key, rawData, TYPE_OCTET_STREAM, BINARY_ENCODING, "no-file");
    }
